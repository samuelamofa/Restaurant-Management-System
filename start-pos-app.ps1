# Start POS App - De Fusion Flame RMS
# This script starts only the POS App

Write-Host "🚀 Starting POS App..." -ForegroundColor Cyan
Write-Host ""
...
$nodeModulesPath = Join-Path $projectRoot "frontend\pos-app\node_modules"
if (-not (Test-Path $nodeModulesPath)) {
    Write-Host "⚠️  POS App dependencies not found. Installing..." -ForegroundColor Yellow
    Set-Location (Join-Path $projectRoot "frontend\pos-app")
    npm install
    Set-Location $projectRoot
}
...
# Get full path to pos-app
$fullPath = Join-Path $projectRoot "frontend\pos-app"
try {
...
Write-Host "Starting POS App..." -ForegroundColor White
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "✅ POS App is starting!" -ForegroundColor Green
Write-Host ""
