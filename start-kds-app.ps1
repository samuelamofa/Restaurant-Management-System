# Start KDS App - De Fusion Flame RMS
# This script starts only the KDS App

Write-Host "🚀 Starting KDS App..." -ForegroundColor Cyan
Write-Host ""
...
$nodeModulesPath = Join-Path $projectRoot "frontend\kds-app\node_modules"
if (-not (Test-Path $nodeModulesPath)) {
    Write-Host "⚠️  KDS App dependencies not found. Installing..." -ForegroundColor Yellow
    Set-Location (Join-Path $projectRoot "frontend\kds-app")
    npm install
    Set-Location $projectRoot
}
...
# Get full path to kds-app
$fullPath = Join-Path $projectRoot "frontend\kds-app"
try {
...
Write-Host "Starting KDS App..." -ForegroundColor White
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "✅ KDS App is starting!" -ForegroundColor Green
Write-Host ""
