# Start Admin App - De Fusion Flame RMS
# This script starts only the Admin App
...
$nodeModulesPath = Join-Path $projectRoot "frontend\admin-app\node_modules"
if (-not (Test-Path $nodeModulesPath)) {
    Write-Host "⚠️  Admin App dependencies not found. Installing..." -ForegroundColor Yellow
    Set-Location (Join-Path $projectRoot "frontend\admin-app")
    npm install
    Set-Location $projectRoot
}
...
# Get full path to admin-app
$fullPath = Join-Path $projectRoot "frontend\admin-app"
try {
...
Write-Host "Starting Admin App..." -ForegroundColor White
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "✅ Admin App is starting!" -ForegroundColor Green
Write-Host ""
